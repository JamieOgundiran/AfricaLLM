...
def preprocess_data(file_path):
    ...
    q_list = [
        'B_COUNTRY_ALPHA', 'B_COUNTRY', 'LNGE_ISO', 'Q27', 'Q28', 'Q29', 'Q30', 'Q31', 'Q32', 'Q33', 'Q34', 'Q35', 'Q37', 'Q38', 'Q39', 'Q40', 'Q41',
        'Q122', 'Q123', 'Q124', 'Q125', 'Q126', 'Q127', 'Q128', 'Q129', 'Q132', 'Q133', 'Q134', 'Q135', 'Q136', 'Q137', 'Q138',
        'Q158', 'Q159', 'Q160', 'Q161', 'Q162', 'Q169', 'Q170', 'Q196', 'Q197', 'Q198',
        'Q224', 'Q225', 'Q226', 'Q227', 'Q228', 'Q229', 'Q230', 'Q231', 'Q232', 'Q233'
    ]
    ...
    avg_row = df_q[q_columns].mean().to_frame().T
    avg_row.index = ['Avg']
    
    # For non-Q columns, leave blank
    for col in df_q.columns:
        if col not in q_columns:
            avg_row[col] = ''
    
    # Ensure columns order matches original
    avg_row = avg_row[df_q.columns]
    
    # Concatenate original data with averages
    df_with_avg = pd.concat([df_q, avg_row], axis=0, ignore_index=False)
